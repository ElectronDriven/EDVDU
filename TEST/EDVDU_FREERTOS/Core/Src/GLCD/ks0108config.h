...
#include "../../Inc/main.h"
	...
	// Pins.....
		...
		#define KS108_DB_High()										HAL_GPIO_WritePin(KS108_DB_PRT,KS108_RS_bp,GPIO_PIN_SET)
		#define KS108_DB_Low()										HAL_GPIO_WritePin(KS108_DB_PRT,KS108_RS_bp,GPIO_PIN_RESET)
	...
	#define KS108_RST_Toggle()							HAL_GPIO_TogglePin(v,GLCD_RST_Pin);
	
	// KS0108  Backlight
	/*#define KS108_BKL_PORT								GPIOA
	#define KS108_BKL_bp										GPIO_PIN_8
	...
	//---------------------------------------------------------------
	...
	#if KS108_PORT_INTERFACE			
		#define KS108_DB_CLR()										HAL_GPIO_WritePin(KS108_DB_PRT,0xFF,GPIO_PIN_RESET)
		#define KS108_DB_PLU()										HAL_GPIO_WritePin(KS108_DB_PRT,0xFF,GPIO_PIN_SET)
		...
		#define KS108_DB_OUT()										Output_DB_GLCD()//{  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3 |GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7;/*GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);*/}
		
		#define KS108_DB_IN()											Input_DB_GLCD()//{  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3 |GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7;/*GPIO_InitStruct.Mode = GPIO_MODE_INPUT;GPIO_InitStruct.Pull = GPIO_NOPULL;HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);*/}
