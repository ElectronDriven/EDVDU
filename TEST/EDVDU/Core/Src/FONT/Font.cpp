...
//-------------------------------------------------
//**** select font
void LcdFont(_const unsigned char *pointer)
{
	FontPointer 			= pointer;
...
/*void TextBoxP(unsigned short x1, unsigned short y1, unsigned short x2, unsigned short y2, _const char *str, unsigned char style)
{
	char 		strP[100+1];
